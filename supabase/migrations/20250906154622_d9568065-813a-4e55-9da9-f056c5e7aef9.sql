...
DROP POLICY IF EXISTS "Public can view anonymized prayer requests" ON public.public_prayer_requests;

-- Allow public access to the safe, anonymized public_prayer_requests view
CREATE POLICY "Public can view anonymized prayer requests" 
